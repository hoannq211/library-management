         ...
         <div class="col-xxl-5">
              <div class="row">
               {{-- <div class="col-12 p-4">
                    <x-notification background="white" type="warning">
                         <x-text type="title" background="red">
                             Cảnh báo
                         </x-text>
                         <div class="body">
                             <x-text type="content" background="danger">
                                 Vui lòng ...
                             </x-text>
                         </div>
                         <div class="button">
                             <x-button background="secondary" color="white">Cancel</x-button>
                        ...
                        <table class="table mb-0">
                             ...
                             <tbody>
                                  <tr>
                                       ...
                                       <td>29 April 2024</td>
                                       <td>
                                            <img src="{{ asset('theme/admin/assets/images/products/product-1(1).png') }}" alt="product-1(1)" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>25 April 2024</td>
                                       <td>
                                            <img src="{{ asset('theme/admin/assets/images/products/product-4.png') }}" alt="product-4" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>25 April 2024</td>
                                       <td>
                                            <img src="{{ asset('theme/admin/assets/images/products/product-5.png') }}" alt="product-5" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>21 April 2024</td>
                                       <td>
                                            <img src="{{ asset('theme/admin/assets/images/products/product-6.png') }}" alt="product-6" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>18 April 2024</td>
                                       <td>
                                            <img src="{{ asset('theme/admin/assets/images/products/product-1(2).png') }}" alt="product-1(2)" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
