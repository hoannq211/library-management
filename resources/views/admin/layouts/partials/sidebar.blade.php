<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
         <ul class="navbar-nav" id="navbar-nav">
              ...
              <li class="nav-item">
                   <a class="nav-link menu-arrow" href="#sidebarBooks" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarBooks">
                        <span class="nav-icon">
                   ...
                   <div class="collapse" id="sidebarBooks">
                        <ul class="nav sub-navbar-nav">
                             <li class="sub-nav-item">
                                  <a class="sub-nav-link" href="{{ route('admin.books.index') }}">Danh sách</a>
                             </li>
                             <li class="sub-nav-item">
                                  <a class="sub-nav-link" href="{{ route('admin.books.create') }}">Tạo Mới</a>
                             </li>
                             <li class="sub-nav-item">
                              <a class="sub-nav-link" href="{{ route('admin.books.archive') }}">Danh Sách Lưu Trữ</a>
                         </li>
                        </ul>
                   </div>
              </li>
