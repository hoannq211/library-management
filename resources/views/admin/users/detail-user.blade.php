                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="bg-primary profile-bg rounded-top p-5 position-relative mx-n3 mt-n3">
                            @if ($user->avatar)
                                <img src="{{ asset('storage/' . $user->getAvatarAttribute()) }}" alt="Avatar"
                                class="avatar-lg border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5">
                            @endif
                        </div>
                        <div class="mt-4 pt-3">
                            <h4 class="mb-1"> {{ $user->name }}<i class="bx bxs-badge-check text-success align-middle"></i>
                            </h4>
                            <div class="mt-2">
                                <p class="fs-15 mb-1 mt-1"><span class="text-dark fw-semibold">Email : </span>
                                    {{ $user->email }}</p>
                                <p class="fs-15 mb-0 mt-1"><span class="text-dark fw-semibold">Phone : </span>{{ $user->phone }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <img src="{{ asset('theme/admin/assets/images/user-profile.png') }}" alt=""
                                    class="img-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <img src="{{ asset('theme/admin/assets/images/users/avatar-2.jpg') }}" alt="avatar-3"
