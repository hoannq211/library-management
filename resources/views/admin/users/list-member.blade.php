                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <a href="#!" class="text-dark fw-medium fs-15">{{ $member->name }}</a>
                                            <p class="text-muted mb-0 mt-1 fs-13">{{ $member->email }}</p>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    @foreach ($member->roles as $role)
                                        <span class="badge bg-light-subtle text-muted border py-1 px-2">{{ $role->name }}</span> 
                                    @endforeach
                                    
                                </td>
                                <td> 
                                    @foreach ($member->all_permissions as $permission)
                                        <span class="badge bg-light-subtle text-muted border py-1 px-2">{{ $permission->name }}</span> 
                                    @endforeach
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="role-edit.html" class="btn btn-soft-primary btn-sm"><iconify-icon
