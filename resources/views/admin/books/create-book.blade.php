                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="book-title" name="title" class="form-control" placeholder="Items title" value="{{ old('title') }}">
                                    @error('title')
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="book-author" name="author" class="form-control" placeholder="Nhập tên tác giả" value="{{ old('author') }}">
                                    @error('author')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="book-publisher" name="publisher" class="form-control" placeholder="Nhập tên nhà xuất bản" value="{{ old('publisher') }}">
                                    @error('publisher')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="book-total-quantity" name="total_quantity" class="form-control" placeholder="Nhập tổng số lượng" value="{{ old('total_quantity') }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="book-isbn" name="isbn" class="form-control" placeholder="Nhập isbn" value="{{ old('isbn') }}">
                                    @error('isbn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
