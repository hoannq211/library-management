                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                             <div class="carousel-inner" role="listbox">
                                  <div class="carousel-item active">
                                       <img src="{{ asset('theme/admin/assets/images/product/p-1.png') }}" alt="" class="img-fluid bg-light rounded">
                                  </div>
                             </div>
                             <div class="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100">
                                  <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="w-auto h-auto rounded bg-light active">
                                       <img src="{{ asset('theme/admin/assets/images/product/p-1.png') }}" class="d-block avatar-xl" alt="swiper-indicator-img">
                                  </button>
                             </div>
                        </div>
                   </div>
         ...
         <div class="col-lg-8">
              <div class="card">
                   <div class="card-body">
                        ...
                        <p class="mb-1">
                             <a href="#!" class="fs-24 text-dark fw-medium">{{ $book->title }}</a>
                        </p>
                        <div class="d-flex gap-2 align-items-center">
                             ...
                             <p class="mb-0 fw-medium fs-18 text-dark">{{ number_format($book->comments_avg_rating, 1) }} <span class="text-muted fs-13">({{ $book->comments_count }})</span></p>
                        </div>
                        ...
                        <div class="quantity mt-4 ">
                             <div class="block">
                                   <h4 class="text-dark fw-medium mt-3">Số Lượng tổng:</h4>
                                   <div class="input-step border bg-body-secondary p-1 mt-1 rounded d-inline-flex overflow-visible">
                                             <div class="text-dark text-center border-0 bg-body-secondary rounded h-100">
                                                  {{ $book->quantity_total }}
                                             </div>
                                   </div>
                                   <h4 class="text-dark fw-medium mt-3">Số Lượng còn tại:</h4>
                                   <div class="input-step border bg-body-secondary p-1 mt-1 rounded d-inline-flex overflow-visible">
                                             <div class="text-dark text-center border-0 bg-body-secondary rounded h-100">
              ...
              <div class="card">
                   ...
                   <div class="card-body">
                        <div class="d-flex align-items-center gap-2">
                             <img src="{{ asset('theme/admin/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-md rounded-circle">
                             <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                             <img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-md rounded-circle">
                             <div>
